...
// Default argument of true for printing a new line after the vector
...
void print_double_vec(const vector<double> &a, bool print_newline){
	...
	// This loop iterates through all the elements except the last, and accesses and prints each element
	// followed by a comma.
