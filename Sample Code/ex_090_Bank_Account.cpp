...
// Accessor
std::string Bank_Account::full_name() const{
	return fn + " " + ln;
}


// Accessor
std::string Bank_Account::first_name() const{
	return fn;
}


// Accessor
std::string Bank_Account::last_name() const{
	return ln;
}


// Accessor
double Bank_Account::checking_balance() const{
	return cb;
}


// Accessor
double Bank_Account::savings_balance() const{
	return sb;
}


// Accessor
double Bank_Account::total_balance() const{
	return cb + sb;
}
