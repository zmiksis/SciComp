...
int main(){
    ...
    {
        double xob; double yob;
        cout << "Enter a pair of x and y coordinates (or a string to exit): ";
        while(cin >> xob >> yob){
            x_obs.push_back(xob);
            y_obs.push_back(yob);
            cout << "Enter a pair of x and y coordinates (or a string to exit): ";
    ...
    if (x_obs.size() < 2){
        cout << "Sample is too small to be useful. You need to enter at least 2 data points." << endl;
        return 0;
    }
