...
int main()
{
  int num_pennies, num_nickels, num_dimes, num_quarters, num_fifties, num_dollars;
  ...
  cents = modf (total/100 , &dollars);
  
  std::cout << "The value of all your coins is $" << dollars << "." << 100*cents << std::endl;
  return 0;
}