...
int main()
{
  int num_pennies, num_nickels, num_dimes, num_quarters, num_fifties, num_dollars, total, dollars, cents;
  ...
  std::cout.width(2);
  std::cout <<"The value of all your coins is $" << std::setprecision(2) << dollars << ".";
  std::setfill('0');
